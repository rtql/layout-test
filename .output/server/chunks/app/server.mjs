...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/bootstrap-a78ec72f.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-0d1b5f61.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  app: () => import('./_nuxt/app-fc8ee179.mjs').then((m) => m.default || m)
};
